...
class TelemetriaRepository:
    ...
    def get_by_dron(self, dron_id: UUID, start_time: Optional[datetime] = None, end_time: Optional[datetime] = None) -> List[Telemetria]:
        """
        ...
        # los tests envian un int pero el modelo tiene UUID, unificar oara que sea UUID
        if isinstance(dron_id, int):
            dron_id = UUID(int=dron_id)
    ...
    def get_stats(self, dron_id: UUID) -> dict:
        """
